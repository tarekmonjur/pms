...
class CommentCreateActivityJob implements ShouldQueue
{
    ...
    public function handle()
    {
        ...
        $activity = "<a><strong>".$fullname."</strong></a> comments on <strong>".$task->task_title."</strong> task.";
        Activity::insert([
            ...
            'task_id' =>$task->id,
            'activity' => $activity,
            'date' => $this->task_comment->created_at
        ]);
    }
}
