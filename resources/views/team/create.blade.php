                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    <div class="form-group {{ $errors->has('team_name') ? ' has-error' : '' }}">
                                        ...
                                        <input type="text" class="form-control" name="team_name" value="{{ old('team_name') }}" placeholder="Enter Team Name">
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    <div class="form-group">
                                        ...
                                        <textarea class="form-control" name="team_details" placeholder="Enter Team Details">{{ old('team_details') }}</textarea>
                                    </div>
                                </div>
                            </div>
